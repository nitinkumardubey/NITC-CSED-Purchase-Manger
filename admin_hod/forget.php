    ...
    <body> <!-- class="back-graund" -->
        <div class="main_div">
          <div class="box" style="margin-left:10%;">  
            ...
            <a href="<?php echo SITEURL; ?>admin_hod/adminlogin.php" class="btn btn-primary">Back</a>  
                  <input type="submit" name="submit" value="Change Password" class="btn-primary" style="margin-right:45%;">
                  <br><br>
                 </form>
...
<?php 
  ...
  if(isset($_POST['submit']))
  {
      ...
      $sql="SELECT * FROM tbl_admin WHERE e_mail='$e_mail'";
      //3.Execute Query
